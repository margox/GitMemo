...
const en: Record<string, string> = {
  ...
  'feat.subtitle': 'Conversations, clipboard, notes — all stored as plain Markdown in your Git repository.',
  ...
  'feat.clipboard.desc': 'Background clipboard monitoring captures text snippets and images automatically, deduplicated with SHA256.',
  ...
  'capture.subtitle': 'GitMemo captures 7 types of knowledge your AI produces — conversations, plans, research, designs, clipboard, memory, and skills. All as plain Markdown in Git.',
...
const zh: Record<string, string> = {
  ...
  'feat.subtitle': '对话、剪贴板、笔记——全部以纯 Markdown 格式存储在你的 Git 仓库中。',
  ...
  'feat.clipboard.desc': '后台剪贴板监听自动捕获文本片段和图片，SHA256 去重。',
  ...
  'capture.subtitle': 'GitMemo 捕获 AI 产出的 7 类知识产物——对话、计划、调研、设计、剪贴板、记忆、技能。全部是 Git 中的纯 Markdown。',

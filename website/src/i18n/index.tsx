...
const en: Record<string, string> = {
  ...
  'feat.notes.title': 'Built-in Notes',
  'feat.notes.desc': 'Create scratch notes, daily notes, and manuals in the same repo where your AI conversations are saved.',
  ...
  'capture.title': 'Keep more than just AI chats',
  'capture.subtitle': 'GitMemo keeps AI conversations, notes you write yourself, saved clipboard items, plans, and project context in one local repo you can search later.',
  'capture.conversations': 'AI Conversations',
  'capture.conversations.desc': 'Saved Claude Code and Cursor sessions in Markdown',
  'capture.notes': 'Notes You Write',
  'capture.notes.desc': 'Scratch notes, daily notes, and manuals you create yourself',
  'capture.plans': 'Plans & Writeups',
  'capture.plans.desc': 'Implementation plans, research notes, and design writeups worth keeping',
  'capture.clipboard': 'Clipboard Captures',
  'capture.clipboard.desc': 'Saved text, code, URLs, images, and file drops when enabled',
  'capture.context': 'AI Project Context',
  'capture.context.desc': 'Claude/Cursor memory, rules, skills, and related project knowledge synced into GitMemo',
  'capture.imports': 'Imported Files',
  'capture.imports.desc': 'Files you drag in or organize so they live alongside the rest of your saved work',
...
const zh: Record<string, string> = {
  ...
  'feat.notes.title': '内置笔记',
  'feat.notes.desc': '在同一份仓库里创建便签、日记和手册，不必把笔记和 AI 对话分散到不同地方。',
  ...
  'capture.title': '不只是保存 AI 对话',
  'capture.subtitle': 'GitMemo 会把 AI 对话、你自己写的笔记、剪贴板内容、计划和项目上下文整理到同一份本地仓库里，方便后续搜索和复用。',
  'capture.conversations': 'AI 对话',
  'capture.conversations.desc': '保存为 Markdown 的 Claude Code / Cursor 会话',
  'capture.notes': '你自己写的笔记',
  'capture.notes.desc': '便签、日记、手册等手动创建的内容',
  'capture.plans': '计划与说明',
  'capture.plans.desc': '值得留下的实施方案、调研笔记和设计说明',
  'capture.clipboard': '剪贴板内容',
  'capture.clipboard.desc': '启用后保存的文本、代码、URL、图片和拖入文件',
  'capture.context': 'AI 项目上下文',
  'capture.context.desc': '同步到 GitMemo 的 Claude/Cursor memory、rules、skills 等项目上下文',
  'capture.imports': '导入文件',
  'capture.imports.desc': '你拖入或整理进来的文件，与其他保存内容放在一起管理',
